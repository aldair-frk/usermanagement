  	...
  	<body class="bg-gray-100 text-gray-800">
		...
		<div class="block mx-auto my-12 p-8 bg-white w-1/3 border border-gray-200 rounded-lg shadow-lg">
			...
			<form class="mt-4" method="POST">
				@csrf
				<input type="text" utofocus class="border border-gray-200 rounded-md bg-gray-200 w-full text-lg placeholder-gray-900 p-2 my-2 focus:bg-white" placeholder="Usuario" name="username">
