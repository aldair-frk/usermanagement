...
class RegisterAttentionsNoMetals extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('RegisterAttentionsNoMetals', function (Blueprint $table) {
    ...
    {
        Schema::dropIfExists('RegisterAttentionsNoMetals');
    }
}
